                        ...
                        <div class="col-lg-6 col-md-5">
                            <div class="cz-product-gallery">
                                <div class="cz-preview">
                                    <span class="for-discount-value p-1 pl-2 pr-2 font-bold fs-13 product-image-discount-badge {{ getProductPriceByType(product: $product, type: 'discount', result: 'value') > 0 ? '' : 'd-none' }}">
                                        <span class="direction-ltr d-block product-image-discount-text">
                                                        ...
                                                        @foreach (json_decode($product->colors) as $key => $color)
                                                            <li>
                                                                ...
                                                                <label style="background: {{ $color }};"
                                                                       class="focus-preview-image-by-color shadow-border {{ (isset($colorStockMap[$color]) && $colorStockMap[$color] <= 0) ? 'color-out-of-stock' : '' }}"
                                                    ...
                                                    @foreach ($choice->options as $index => $option)
                                                        <div class="user-select-none">
                                                            <div class="for-mobile-capacity">
                                                                ...
                                                                <label class="__text-12px {{ (isset($optionStockMap[$choice->name][$option]) && $optionStockMap[$choice->name][$option] <= 0) ? 'option-out-of-stock' : '' }}"
