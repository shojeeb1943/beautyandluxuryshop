...
@section('title', translate('update_Color'))
            ...
            <div class="col-md-12">
                <div class="card mb-3">
                    <div class="card-body text-start">
                        <form action="{{ route('admin.color.update', $color->id) }}" method="post" class="color-setup-form">
                            @csrf
                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-column gap-20">
                                        ...
                                        <div class="d-flex justify-content-center align-items-center">
                                            <div id="colorPreview" 
                                                 style="width: 100px; height: 100px; background-color: {{ old('code', $color->code) }}; border: 2px solid #ddd; border-radius: 8px;">
                                            </div>
                                        </div>
