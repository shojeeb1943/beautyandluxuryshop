...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => ['admin', 'actch:admin_panel']], function () {
    ...
    Route::group(['prefix' => 'color', 'as' => 'color.', 'middleware' => ['module:product_management']], function () {
        Route::controller(\App\Http\Controllers\Admin\Product\ColorController::class)->group(function () {
    ...
    Route::get('/debug-colors', function() {
        ...
        echo "<p><strong>Note:</strong> Remove this route from routes/admin/routes.php after debugging!</p>";
    });
});
