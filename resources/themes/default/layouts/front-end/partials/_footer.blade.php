        ...
        Discover Beauty & Luxury Shop — your trusted destination in Bangladesh for 100% authentic beauty, skincare, makeup, and luxury fragrance products. We bring you a world of premium beauty, offering only genuine, brand-authorized items sourced directly from reputable distributors and global suppliers.
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-4 col-6 footer-padding-bottom text-start">
                                ...
                                <ul class="widget-list __pb-10px">
                                    ...
                                    @php(
                                        $businessPages = collect($allowSlugs)
                                            ->map(fn($slug) => $web_config['business_pages']->firstWhere('slug', $slug))
                                            ->filter()
                                    )
                ...
                <div class="row py-3">
                    <div class="col-12 text-center">
                        <img src="{{ asset('assets/front-end/img/ssl-commerz-footer-image.png') }}"
                    ...
                    <div class="col-xl-5 col-md-6">
                        ...
                        <div class="row text-start">
                            <div class="col-12 start_address ">
                                ...
                                <div class="pe-3">
                                    {{-- Support ticket link hidden per request
@if(auth('customer')->check())
