...
class WebsiteSetupRequest extends Request
{
    ...
    {
        return [
            'company_web_logo' => 'sometimes|mimes:jpg,jpeg,png,gif,webp,svg|max:1024',
            'company_footer_logo' => 'sometimes|mimes:jpg,jpeg,png,gif,webp,svg|max:1024',
            'company_fav_icon' => 'sometimes|mimes:jpg,jpeg,png,gif,webp,svg|max:1024',
            'loader_gif' => 'sometimes|mimes:jpg,jpeg,png,gif,webp|max:1024',
            'company_mobile_logo' => 'sometimes|mimes:jpg,jpeg,png,gif,webp,svg|max:1024',
    ...
    {
        return [
            'company_web_logo.mimes' => translate('the_company_web_logo_must_be_a_file_of_type_jpg_jpeg_png_gif_webp_svg'),
            ...
            'company_footer_logo.mimes' => translate('the_company_footer_logo_must_be_a_file_of_type_jpg_jpeg_png_gif_webp_svg'),
            ...
            'company_fav_icon.mimes' => translate('the_company_fav_icon_must_be_a_file_of_type_jpg_jpeg_png_gif_webp_svg'),
            'company_fav_icon.max' => translate('the_company_fav_icon_may_not_be_greater_than_1024_kilobytes'),

            'loader_gif.mimes' => translate('the_loader_gif_must_be_a_file_of_type_jpg_jpeg_png_gif_webp'),
            'loader_gif.max' => translate('the_loader_gif_may_not_be_greater_than_1024_kilobytes'),

            'company_mobile_logo.mimes' => translate('the_company_mobile_logo_must_be_a_file_of_type_jpg_jpeg_png_gif_webp_svg'),
